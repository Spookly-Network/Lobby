...
public class DatabaseLib implements Closeable {
    ...
    public DatabaseLib(LobbySystem lobbySystem) {
        this.lobbySystem = lobbySystem;
        HikariConfig hikariConfig = new HikariConfig();
        hikariConfig.setJdbcUrl((String) lobbySystem.getGeneralConfig().getOrSetDefault("config.database.url", "jdbc:mysql://localhost:3306/database"));
        hikariConfig.setUsername((String) lobbySystem.getGeneralConfig().getOrSetDefault("config.database.username", "username"));
        hikariConfig.setPassword((String) lobbySystem.getGeneralConfig().getOrSetDefault("config.database.password", "password"));
        hikariConfig.addDataSourceProperty("cachePrepStmts", "true");
        hikariConfig.addDataSourceProperty("prepStmtCacheSize", "250");
        hikariConfig.addDataSourceProperty("prepStmtCacheSqlLimit", "2048");
        lobbySystem.getGeneralConfig().save();
